...
def main(player, enemy):
    ...
    MODELS = 10 #Общее  количество моделей
    BATCH_SIZE = 32
    EPSILON = 1.0
    EPSILON_MIN = 0.1
    EPSILON_DECAY = 0.95
    ...
    for i in range(MODELS):
        ...
        torch.save(model.state_dict(), f"D:/Programs/Tima/NN/models/first/{"x" if player == 1 else "o"}/q_model_{player}_{i}.pth")
        print(f'Model №{i}')
